...
import { Avatar, Box, Button, ClickAwayListener, Grow, MenuItem, Paper, Popper, Typography, MenuList, Link } from '@mui/material';
import IconButton from '@mui/material/IconButton';
import { useRecoilValue, useResetRecoilState } from 'recoil';
import { firebaseAuth } from "services/auth";
import { useHistory } from "react-router-dom";
import { Logout, Groups2 } from '@mui/icons-material';
                                    ...
                                    <Paper className={style.dropdownUserInfoItem} elevation={4}>
                                        <MenuItem>
                                            <Box display="flex" flexDirection="row">
                                                {typeof authUser.picture != 'undefined' && authUser.picture ? (<Avatar src={authUser.picture} />) : (<Avatar />)}
                                                <Typography noWrap display="flex" alignItems="center" marginX={2} variant="subtitle1" color="white">{authUser?.name}</Typography>
                                            </Box>
                                        </MenuItem>
